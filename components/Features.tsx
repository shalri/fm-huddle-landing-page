export default function Features() {
  return (
    <section className="">
      ...
      <div className="bg-white bg-[url(/images/bg-section-bottom-mobile-1.svg)] sm:bg-[url(/images/bg-section-bottom-desktop-1.svg)] bg-contain  bg-top bg-no-repeat pb-16 pt-[190px] sm:pt-[330px]">
